...
public class Venta  implements java.io.Serializable {
    ...
    public Venta(int idVenta, Date fechaVenta, String descripcion, double total, boolean estatus, int usuarioUltimoAjuste) {
    ...
    public Venta(int idVenta, Date fechaVenta, Date fechaVentaSaldada, Date fechaUltimoAbono, Integer detalleVenta, String descripcion, Double abono, double total, boolean estatus, int usuarioUltimoAjuste, Boolean credito, String metodoPago) {
       this.idVenta = idVenta;
       this.fechaVenta = fechaVenta;
